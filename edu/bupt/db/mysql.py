...
class MySQL:
    ...
    def insert(self, table_name, data):
        ...
        'INSERT INTO `map`(`y`,`x`,`id`) VALUES (%s,%s,%s)'

    def insetBatch(self, table_name, datas):
        ...
        _list_params = []
        for data in datas:
            params = tuple([data[key] for key in columns])
            _list_params.append(params)
        return self.cur.executemany(_sql, _list_params)
...
if __name__ == '__main__':
    ...
    #     n.insert(tbname,d)
    # n.commit()
    n.query('select title from tb_doc limit 100')
    result = n.fetchAll()
